                    ...
                    <div id="timetable" class="form  w3-margin w3-whitesmoke w3-bar-block">
                        ...
                        <div id="modalDialog" class="modal">
                            <div class="con1">
                                ...
                                <br>
                                <label for="day" style="padding-left:1rem">Day:<p id="day" style="padding-left:1rem">
                                    </p>
                                </label>
                                <label for="time" style="padding-left:1rem">Time:<p id="time" style="padding-left:1rem">
                                    </p>
                                </label>
                                <div class="form__div">
