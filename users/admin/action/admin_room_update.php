    ...
    <div>
        ...
        <div class="l-form">
            <form method="POST" class="form  w3-margin w3-whitesmoke" style="width:24rem;height:auto">
                ...
                <br>
                <div class="form__div">
                    <input type="number" class="form__input" name="RoomNo" id="RoomNo" placeholder="e.g 8" autocomplete="off" disabled="disabled" value="<?php echo $result_get["RoomNo"]; ?>">
                    <label for="" class="form__label">Room No</label>
                </div>
                <br>
                <div class="form__div">
                    <input type="number" class="form__input" name="Floor" id="Floor" placeholder="e.g 3" autocomplete="off" value="<?php echo $result_get["Floor"]; ?>">
                    <label for="" class="form__label">Floor</label>
                </div>
                <br>
                <div class="form__div">
                    <input type="number" class="form__input" name="Capacity" id="Capacity" placeholder="e.g 98" autocomplete="off" value="<?php echo $result_get["Capacity"]; ?>">
