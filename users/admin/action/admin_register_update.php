    ...
    <div>
        ...
        <div class="l-form">
            <form method="POST" class="form  w3-margin w3-whitesmoke" style="width:66vw">
                ...
                <br>
                <div class="form__div">
                    <input type="text" class="form__input" name="FirstName" id="FirstName" placeholder="e.g xyz" autocomplete="off" value="<?php echo $result_get['FirstName']; ?>">
                    <label for="" class="form__label">First Name</label>
                </div>
                <br>

                <div class="form__div">
                    <input type="text" class="form__input" name="LastName" id="LastName" placeholder="e.g xyz@123" autocomplete="off" value="<?php echo $result_get['LastName']; ?>">
                ...
                <br>
                <div class="form__div">
                    <input type="text" class="form__input" name="Emailid" id="Emailid" placeholder="e.g someone@gmail.com" autocomplete="off" value="<?php echo $result_get['Email']; ?>">
                    <label for="" class="form__label">Email</label>
                </div>
                <br>
                <div class="form__div">
                    <input type="text" class="form__input" name="Phone" id="Phone" placeholder="e.g 8828*****" autocomplete="off" value="<?php echo $result_get['Phone']; ?>">
                    <label for="" class="form__label">Phone</label>
                </div>
                <br>

                <div class="form__div">
                    <input type="text" class="form__input" name="Username" id="Username" placeholder="e.g xyz" autocomplete="off" value="<?php echo $result_get['Username']; ?>">
                    <label for="" class="form__label">Username</label>
                </div>
                <br>
                <div class="form__div">
                    <input type="password" class="form__input" name="Password" id="Password" placeholder="e.g xyz@1234" autocomplete="off" value="<?php echo $result_get['Password']; ?>">
                ...
                <br>
                <br>
                <input class="button-primary w3-button w3-border w3-hover-blue w3-round" type="submit" value="Update" name="update" style="float:right">
        </div>
        </form>
    </div>
