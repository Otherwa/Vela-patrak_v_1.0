    ...
    <body>
        ...
        <div class="l-form">
            <form method="POST" class="form  w3-margin w3-whitesmoke" style="width:33rem">
                ...
                <div class="form__div">
                    <input type="text" class="form__input" name="Department" id="Department" placeholder="e.g xyz" autocomplete="off">
                ...
                <div class="form__div">
                    <input type="password" class="form__input" name="Password" id="Password" placeholder="e.g xyz" autocomplete="off">
